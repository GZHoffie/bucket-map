...
def test_markov_chain(fasta_file_name, pickle_file_name=None, test_num=1000, order=6, region_length=10000, read_length=100, substitution_rate=0.02, prior=0.001):
